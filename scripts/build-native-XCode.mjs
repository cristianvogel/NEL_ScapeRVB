...
if (os.platform() === 'darwin') {
    // macOS specific code // -G Xcode for Xcode project
      await $`cmake -G Xcode -DCMAKE_BUILD_TYPE=${buildType} -DCMAKE_INSTALL_PREFIX=./out/ -DCMAKE_TOOLCHAIN_FILE=${rootDir}/toolchain.cmake -DCMAKE_OSX_DEPLOYMENT_TARGET=13 -DCMAKE_OSX_ARCHITECTURES="arm64" ${devFlag} ../..`;
